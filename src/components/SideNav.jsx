    ...
    <div>
      ...
      <div className="">
        <ul className="flex flex-col gap-10 mt-10">
            <li><Link className="Links" to='/Shop'>Loja</Link></li>
            <li><Link className="Links" to='/NewArrival'>Novidades</Link></li>
            <li><Link className="Links" to='/TopSelling'>Mais vendidos</Link></li>
