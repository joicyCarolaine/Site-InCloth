        ...
        <div className='flex flex-wrap shop:flex-nowrap mainMargin gap-5'>
            <div className='p-4 flex-grow gap-5 rounded-xl h-fit border-4 flex flex-col shop:max-w-[300px] shop:min-w-[300px]'>
                <div onClick={() => setArrows({ type: 'filter' })} className='select-none cursor-pointer flex justify-between'>
                    <p className='font-bold text-2xl'>Filtros</p>
                    ...
                    Arrows.filter && <>
                        ...
                        <div className=' flex-col gap-3'>
                            <div className='flex justify-between cursor-pointer' onClick={() => setArrows({ type: 'price' })}>
                                <p className='font-bold text-xl select-none'>Preço</p>
                                <motion.div
                        ...
                        <div className=' flex-col gap-3'>
                            <div className='flex justify-between cursor-pointer' onClick={() => setArrows({ type: 'colors' })}>
                                <p className='font-bold text-xl select-none'>Cores</p>
                                <motion.div
                                ...
                                Arrows.colors && <motion.div
                                    ...
                                    <div className='flex gap-3 flex-wrap mt-10'>
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '1')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '2')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '3')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '4')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '5')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '6')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '7')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '8')}
                                        ...
                                        <motion.div
                                            ...
                                            onClick={() => handleFiltersChange('colorbg', '9')}
                                            className='bg-gray-500 w-8 h-8 rounded-full cursor-pointer'
                                            title="Cinza Claro"
                                        />
                                    </div>
                                </motion.div>
                        ...
                        <div className='flex justify-between flex-col gap-3'>
                            <div className='flex justify-between cursor-pointer' onClick={() => setArrows({ type: 'style' })}>
                                <p className='font-bold text-xl select-none'>Estilo</p>
                                <motion.div
                ...
                <div className='flex justify-center flex-grow flex-wrap gap-3 h-fit'>
                    {
                        ...
                        }) : <h1 className='text-3xl mt-10 font-bold'>Desculpe, nada aqui...</h1>
                    }
                </div>
