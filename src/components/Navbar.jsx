        ...
        >
          ...
          className=" bg-white w-full mainPadding py-4 flex items-center nav:gap-12 gap-0 justify-between ">
            <motion.span initial={{opacity:0,y:100}} animate={{opacity:1,y:0}}>
              <Link className="text-2xl xsm:text-4xl font-bold bolded" to=''>InCloth</Link>
            </motion.span>
            <div className="hidden nav:block mt-3">
              <ul className="flex gap-5">
              <motion.li initial={{opacity:0,y:100}} animate={{opacity:1,y:0}}><Link className="Links" to='/Shop'>Loja</Link></motion.li>
            <motion.li initial={{opacity:0,y:100}} animate={{opacity:1,y:0}}><Link className="Links" to='/NewArrival'>Novidades</Link></motion.li>
            <motion.li initial={{opacity:0,y:100}} animate={{opacity:1,y:0}}><Link className="Links" to='/TopSelling'>Mais vendidos</Link></motion.li>
              </ul>
            </div>
            ...
            <div className='lg:flex-grow'>
              ...
              className="bg-gray-100 p-1 px-3 rounded-full hidden nav:flex mt-3 gap-2" onSubmit={handleFormSubmit}>
                ...
                <input ref={search} className="p-1 outline-none w-full bg-transparent" type="text" placeholder="Pesquisar produtos..." />
              </motion.form>
            </div>
